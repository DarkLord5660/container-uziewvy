...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-uziewvy.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-uziewvy.containers.anotherwebservice.com/
...
```
git clone git@github.com:DarkLord5660/container-uziewvy.git
cd container-uziewvy
```
...
```
docker attach container-uziewvy
```
